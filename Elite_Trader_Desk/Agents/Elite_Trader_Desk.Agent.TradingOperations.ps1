...
if (Test-Path $AgentCommPath) {
    ...
    & $AgentCommPath -AgentName "Elite_Trader_Desk.Agent.TradingOperations" -Division "Elite_Trader_Desk" -InitializeNetwork

    # Communication functions for agent use
    function Send-AgentMessage {
        param([string]$To, [string]$Type, [string]$Content, [string]$Priority = "Normal")
        & $AgentCommPath -AgentName "Elite_Trader_Desk.Agent.TradingOperations" -TargetAgent $To -MessageType $Type -MessageContent $Content -Priority $Priority -SendMessage
    }

    function Receive-AgentMessages {
        return & $AgentCommPath -AgentName "Elite_Trader_Desk.Agent.TradingOperations" -ReceiveMessages
    }

    function Broadcast-Message {
        param([string]$Type, [string]$Content, [string]$Priority = "Normal")
        & $AgentCommPath -AgentName "Elite_Trader_Desk.Agent.TradingOperations" -MessageType $Type -MessageContent $Content -Priority $Priority -Broadcast
    }
    ...
    Write-Host "ðŸ”— Agent communication system initialized for Elite_Trader_Desk.Agent.TradingOperations" -ForegroundColor Cyan
}
