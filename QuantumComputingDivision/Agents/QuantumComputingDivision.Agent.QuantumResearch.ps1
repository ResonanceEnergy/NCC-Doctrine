...
if (Test-Path $AgentCommPath) {
    ...
    & $AgentCommPath -AgentName "QuantumComputingDivision.Agent.QuantumResearch" -Division "QuantumComputingDivision" -InitializeNetwork

    # Communication functions for agent use
    function Send-AgentMessage {
        param([string]$To, [string]$Type, [string]$Content, [string]$Priority = "Normal")
        & $AgentCommPath -AgentName "QuantumComputingDivision.Agent.QuantumResearch" -TargetAgent $To -MessageType $Type -MessageContent $Content -Priority $Priority -SendMessage
    }

    function Receive-AgentMessages {
        return & $AgentCommPath -AgentName "QuantumComputingDivision.Agent.QuantumResearch" -ReceiveMessages
    }

    function Broadcast-Message {
        param([string]$Type, [string]$Content, [string]$Priority = "Normal")
        & $AgentCommPath -AgentName "QuantumComputingDivision.Agent.QuantumResearch" -MessageType $Type -MessageContent $Content -Priority $Priority -Broadcast
    }
    ...
    Write-Host "ðŸ”— Agent communication system initialized for QuantumComputingDivision.Agent.QuantumResearch" -ForegroundColor Cyan
}
