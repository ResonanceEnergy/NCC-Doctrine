...
function Test-CompanyMissionStatement {
    ...
    if (Test-Path $MissionPath) {
        Write-Host "✓ Mission statement exists for $CompanyName" -ForegroundColor Green
        return $true
    } else {
        Write-Host "✗ Mission statement missing for $CompanyName - Creating..." -ForegroundColor Yellow
        return $false
    }
}
...
"@
    ...
    Write-Host "✓ Created mission statement for $CompanyName" -ForegroundColor Green
}
...
function New-CompanyDirective {
    ...
    Write-Host "`n🔍 Analyzing intelligence for $CompanyName..." -ForegroundColor Cyan
...
"@
    ...
    Write-Host "✓ Created directive: $directiveName" -ForegroundColor Green
    Write-Host "📄 Saved to: $directivePath" -ForegroundColor Cyan
    
    return $directive
}

# Main execution
Write-Host "🚀 NCC Hierarchical Directive System - Intelligence Compilation" -ForegroundColor Magenta
Write-Host "Version 1.0.0 | Date: 2026-01-29" -ForegroundColor Gray
Write-Host ""

if ($VerifyMissionStatements) {
    Write-Host "🔍 Verifying mission statements for all companies..." -ForegroundColor Cyan
...
if ($AllCompanies) {
    Write-Host "🎯 Creating directives for all companies..." -ForegroundColor Cyan
    ...
    Write-Host "❓ Please specify -CompanyName or use -AllCompanies" -ForegroundColor Yellow
