...
# InternationalOperationsDivision Integration Agent
...
if (Test-Path $AgentCommPath) {
    ...
    & $AgentCommPath -AgentName "$DivisionName.Agent.$AgentRole" -Division "Integration" -InitializeNetwork
