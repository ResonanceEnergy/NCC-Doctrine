...
# InternationalOperationsDivision Analytical Agent
...
if (Test-Path $AgentCommPath) {
    ...
    & $AgentCommPath -AgentName "$DivisionName.Agent.$AgentRole" -Division "Analytical" -InitializeNetwork
