...
# InternationalOperationsDivision Security Agent
...
if (Test-Path $AgentCommPath) {
    ...
    & $AgentCommPath -AgentName "$DivisionName.Agent.$AgentRole" -Division "Security" -InitializeNetwork
