...
# InternationalOperationsDivision Innovation Agent
...
if (Test-Path $AgentCommPath) {
    ...
    & $AgentCommPath -AgentName "$DivisionName.Agent.$AgentRole" -Division "Innovation" -InitializeNetwork
