# NATRIX COMMAND CORP Organizational Structure
...
- **Components:**
  - Flow Cube Project (New Addition)

### Missing Projects (Status: Under Investigation)
The following projects require location verification and integration:
- **Butterfield Acres**
- **Grip and Ripp HDD (High Definition Development)**

**Located Projects:**
- **Uruguay Project:** Found under REC > Micro Hydro Project
- **Paraguay Project:** Found under REC > Micro Hydro Project
